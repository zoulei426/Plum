...
namespace Plum.Windows.Tools
{
    ...
    public class ControlTool
    {
        ...
        /// </summary>
        public static readonly DependencyProperty MouseOverBackgroundProperty = DependencyProperty.RegisterAttached("MouseOverBackground", typeof(Brush), typeof(ControlTool), new PropertyMetadata(null));
        ...
        /// </summary>
        public static readonly DependencyProperty MouseOverForegroundProperty = DependencyProperty.RegisterAttached("MouseOverForeground", typeof(Brush), typeof(ControlTool), new PropertyMetadata(null));
        ...
        /// </summary>
        public static readonly DependencyProperty FollowTargetProperty = DependencyProperty.RegisterAttached("FollowTarget", typeof(DependencyObject), typeof(ControlTool), new PropertyMetadata(null, FollowTargetChanged));
