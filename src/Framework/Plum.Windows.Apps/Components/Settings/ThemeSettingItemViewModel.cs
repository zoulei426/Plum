...
namespace Plum.Windows.Apps.Components.Settings
{
    ...
    public class ThemeSettingItemViewModel : ViewModelBase, IViewLoadedAndUnloadedAware
    {
        #region Properties
        ...
        public ThemeSettingItemViewModel(IContainerExtension container) : base(container)
        {
        }
