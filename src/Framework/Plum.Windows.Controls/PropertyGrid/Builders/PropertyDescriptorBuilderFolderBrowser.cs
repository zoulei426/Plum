...
namespace Plum.Windows.Controls
{
    ...
    /// 自定义文件打开选择器控件
    /// </summary>
    public class PropertyDescriptorBuilderFolderBrowser : PropertyDescriptorBuilder
    {
        #region Fields
            ...
            defaultValue.Designer.Dispatcher.Invoke(() =>
            {
                ...
                var button = new Button()
                {
                    ...
                    Command = new DelegateCommand(() =>
                    {
                        ...
                        {
                            defaultValue.Value = fbd.SelectedPath;
                        }
                    }),
                    Width = 50,
        ...
        public PropertyDescriptorBuilderFolderBrowser() : this("所有文件(*.*)|*.*")
        {
        }

        public PropertyDescriptorBuilderFolderBrowser(string filter)
        {
            _filter = filter;
        }
